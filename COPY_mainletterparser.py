...
def letter_parse(file, threshold, bubble_found):
    ...
    # tuples of (x_location_first_letter, ylocation_first_letter, xlocation_last_letter, ylocation_last_letter)
    letterLocation = [];    
                        ...
                        for char_obj in box_obj:
                            ...
                            if isinstance(char_obj, LTText) and (is_letter(char_obj.get_text()) == True):
                                ...
                                if (first_char_found == True):
                                    ...
                                    letterLocation.append((xlocation_first_letter, ylocation_first_letter, xlocation_last_letter, ylocation_last_letter))
                                    string_word = ""
                                    first_char_found = False
